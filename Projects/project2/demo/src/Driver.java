...
// Test clear
   ...
   public static void testHashTable()
   {
      ...
      nameList.add(new Name("Tabatha", "Ken"), "555-1234");
      nameList.add(new Name("Toni", "Ken"), "555-1235");
      nameList.add(new Name("Tobbie", "Ken"), "555-1236");
      nameList.add(new Name("Tabbie", "Ken"), "555-1237");
      nameList.add(new Name("Tim", "Ken"), "555-1238");
      ...
      nameList.remove(new Name("Tabatha", "ken"));
      nameList.add(new Name("Nancy", "ken"), "555-1239");
      System.out.println("Dictionary contains " + nameList.getSize() + " (should be 5) items, as follows:\n");
      display(nameList);
      System.out.println("\nThe hash table is:\n");
      ...
      nameList.remove(new Name("Toni", "ken"));
      nameList.add(new Name("Derek", "ken"), "555-1240");
      System.out.println("Dictionary contains " + nameList.getSize() + " (should be 5) items, as follows:\n");
      display(nameList);
      System.out.println("\nThe hash table is:\n");
      nameList.displayHashTable();
      ...
      nameList.remove(new Name("Tabbie", "ken"));
      nameList.add(new Name("Carole", "Ken"), "555-1241");
      System.out.println("Dictionary contains " + nameList.getSize() + " (should be 5) items, as follows:\n");
      display(nameList);
      System.out.println("\nThe hash table is:\n");
      nameList.displayHashTable();
      ...
      nameList.remove(new Name("Tobbie", "Ken"));
      nameList.add(new Name("Bette", "Ken"), "555-1242");
      System.out.println("Dictionary contains " + nameList.getSize() + " (should be 5) items, as follows:\n");
      display(nameList);
      System.out.println("\nThe hash table is:\n");
      nameList.displayHashTable();
      ...
      nameList.remove(new Name("Tim", "Ken"));
      nameList.add(new Name("Reiss","Ken"), "555-1243");
      System.out.println("Dictionary contains " + nameList.getSize() + " (should be 5) items, as follows:\n");
      display(nameList);
      System.out.println("\nThe hash table is:\n");
      nameList.displayHashTable();
      ...
      nameList.remove(new Name("Derek", "Ken"));
      nameList.add(new Name("Miguel", "Ken"), "555-1244");
      System.out.println("Dictionary contains " + nameList.getSize() + " (should be 5) items, as follows:\n");
      display(nameList);
      System.out.println("\nThe hash table is:\n");
      nameList.displayHashTable();
      ...
      nameList.remove(new Name("Bette", "Ken"));
      nameList.add(new Name("Tom", "Ken"), "555-1245");
      System.out.println("Dictionary contains " + nameList.getSize() + " (should be 5) items, as follows:\n");
      display(nameList);
      System.out.println("\nThe hash table is:\n");
      nameList.displayHashTable();
